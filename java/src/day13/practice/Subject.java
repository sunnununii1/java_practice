...
public class Subject {
	...
	//멤버변수
	private String title;		//과목명: 국, 영, 수
	private double total;		//과목 총점: 중간+기말+수행
	...
	//메서드
	/** 중간고사 성적 추가하는 메서드 /수정 setMidTerm */

	/** 기말고사 성적 추가하는 메서드 /수정 setFinalTerm */
	
	/** 수행평가 성적 추가하는 메서드 /수정 setPerformance */
