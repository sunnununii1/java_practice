...
public class ShopServiceImp implements ShopService {
	...
	public int sell(Product[] list, int count, Customer[] customerList, int customerCount, Sales[] salesHistory,
		...
		//각 리스트의 최대 크기가 각 개수보다 크거나, 같은지 체크
		if(list.length < count || customerList.length < customerCount ||
		...
		sellProduct.setAmount(amount); //판매 제품정보 만듬
