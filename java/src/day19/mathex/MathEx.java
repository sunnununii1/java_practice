...
public class MathEx {
	...
	public static void main(String[] args) {
		...
		System.out.println(Math.abs(-1.2)); //-1.2의 절댓값
		System.out.println(Math.ceil(-1.29)); //-1.29의 소수점 첫번째 자리에서 옮김
		...
		System.out.println(Math.random()); //0이상 1미만의 난수(랜덤수)
		
		//1.29의 소수점 둘째자리에서 반올림하기
		double num = 1.29;
		//num *= 10;
