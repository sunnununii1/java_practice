...
public class BoardController {
	...
	//매핑url은 뒤에 변수와 맞추는 게 아니라 @PathVariable에 선언한 이름과 맞추는 것
	public String detail(Model model, @PathVariable("bo_num")int num) {
		BoardVO board= boardService.getBorad(num);
		List<FileVO> fileList = boardService.getFileList(num); //이 게시글과 맞는 첨부파일 요청
